...
from benchpress.stats import mannwhitney_p, effect_size_cohen_d
...
def print_comparison(a: BenchmarkStats, b: BenchmarkStats) -> None:
    ...
    p_tps = mannwhitney_p(a.tps_samples, b.tps_samples)
    p_ttft = mannwhitney_p(a.ttft_samples, b.ttft_samples)
    ...
    console.print(table)
    console.print(
        f"  [dim]* p < 0.05 (Mann-Whitney U, two-sided). "
